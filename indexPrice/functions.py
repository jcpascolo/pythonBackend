...
def weight_price(prices, weight):
    return weight * return_underlying_security(prices["current"], prices["before"])
...
def price_of_index(index_price_before, security_prices_weight):
    return index_price_before * (1 + return_of_index(security_prices_weight))
